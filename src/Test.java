...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student(1810, "Иванов", 4.2));
        students.add(new Student(1911, "Кворцов", 4.5));
        students.add(new Student(2201, "Медведев", 3.8));
        students.add(new Student(1297, "Шойгу", 4.8));
        students.add(new Student(2518, "Трофимова", 3.5));
        students.add(new Student(1111, "Петрова", 3.2));
        ...
        students2[1] = new Student(1552, "Друздь", 3.9);
        students2[2] = new Student(1553, "Уланов", 3.8);
        students2[3] = new Student(1554, "Белый", 2.7);
